...
func runWebhookServer(c *cli.Context, serverType string) error {
	logrus.Info("Starting longhorn admission webhook server")
	...
	s := server.New(ctx, cfg, namespace, serverType)
