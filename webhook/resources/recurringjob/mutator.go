...
func (r *recurringJobMutator) Create(request *admission.Request, newObj runtime.Object) (admission.PatchOps, error) {
	return mutateRecurringJobOnCreate(newObj)
}
...
func (r *recurringJobMutator) Update(request *admission.Request, oldObj runtime.Object, newObj runtime.Object) (admission.PatchOps, error) {
	return mutateRecurringJobOnUpdate(newObj)
}

func mutateRecurringJobOnCreate(newObj runtime.Object) (admission.PatchOps, error) {
...
func mutateRecurringJobOnUpdate(newObj runtime.Object) (admission.PatchOps, error) {
	var patchOps admission.PatchOps
