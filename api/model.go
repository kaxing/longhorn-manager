...
func toOrphanResource(orphan *longhorn.Orphan, apiContext *api.ApiContext) *Orphan {
	return &Orphan{
		Resource: client.Resource{
			Id:   orphan.Name,
			Type: "orphan",
...
func toOrphanCollection(orphans []*longhorn.Orphan, apiContext *api.ApiContext) *client.GenericCollection {
	data := []interface{}{}
	for _, orphan := range orphans {
		data = append(data, toOrphanResource(orphan, apiContext))
	}
